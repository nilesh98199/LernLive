...
const MeetingModel = ({ isOpen, onClose, title, className, children, handleClick, buttonText, image, buttonIcon}: MeetingModalProps) => {
  ...
  <DialogContent className="flex w-full max-w-[520px] flex-col gap-9 border-none bg-dark-1 px-6 py-9 text-white">
    ...
    <div className="flex flex-col gap-6">
      ...
      <h1 className={cn('text-3xl font-bold leading-[35px]', className)}>{title}</h1>
      {children}
